...
import { activateUserApiCallResult } from "@utils/apiUtils";
...
export default function ActivateUser() {
  ...
  const handleValidate = () => {
    const activateUserApiCall = activateUserApiCallResult(email, token);
    ...
    activateUserApiCall
      ...
      .catch(() => {
        setNotification({ message: "Confirmation echoué", variant: "error" });
